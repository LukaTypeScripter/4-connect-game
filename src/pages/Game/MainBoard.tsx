...
import { boardLayerBlackLArge, boardLayerWhiteLarge } from "../../assets/images"
...
const MainBoardCont = styled.section`
display: grid;
margin-top: 5rem;
gap: 6rem;
position: relative;
